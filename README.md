                    ...
                    for x,y in pairs(game.Workspace.Enemies:GetChildren()) do
                        if v.Name == y.Name then
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health >= 1 then
                                ...
                                y.HumanoidRootPart.CanCollide = true
                                v.Head.CanCollide = true
                                y.Head.CanCollide = true
...
spawn(function()
    while task.wait() do
        if _G.AutoFarm and _G.AutoFarm then
            pcall(function()
                CheckQuest()
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                for x,y in pairs(game.Workspace.Enemies:GetChildren()) do
    ...
    while true do wait()
        getgenv().rejoin = game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(Kick)
            if not _G.TP_Ser and _G.Rejoin then
                if Kick.Name == 'ErrorPrompt' and Kick:FindFirstChild('MessageArea') and Kick.MessageArea:FindFirstChild("Rejoin Game:AutoExecScript;) ") then
...
local TestTab11 = Page2:CreateSection({
    Name = "Fruits",
    Side = "Left"
})

local TestTab12 = Page2:CreateSection({
    Name = "Raid",
    Side = "Right"
})
...
TestTab11:AddToggle({
	...
	Value = _G.AutoRandom, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
        _G.AutoRandom = value
    end
})
...
ItemList = {"Bomb-Bomb","Spike-Spike","Chop-Chop","Spring-Spring","Kilo-Kilo","Smoke-Smoke","Spin-Spin","Flame-Flame","Brid-Bird: Falcon","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Love-Love","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Door-Door","Quake-Quake","Human-Human: Buddha","String-String","Bird-Bird: Phoenix","Rumble-Rumble","Paw-Paw","Gravity-Gravity","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Soul-Soul","Dragon-Dragon"}

TestTab11:AddDropdown({
	Name = "Fruit",
	Value = "",
	List = ItemList,
	Callback = function(value)
...
TestTab11:AddToggle({
    Name = "StoreFruit",
	Value = _G.StoreFruit, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
        _G.StoreFruit = value
    end
})

local TestTab1 = Page1:CreateSection({
    Name = "Main",
    Side = "Left"
})

local TestTab2 = Page1:CreateSection({
    Name = "Stats", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})

local TestTab3 = Page1:CreateSection({
    Name = "Fighting Style", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})

local TestTab4 = Page1:CreateSection({
    Name = "Code", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})


local TestTab5 = Page1:CreateSection({
...
local TestTab6 = Page1:CreateSection({
    Name = "Fram Bone", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})


local TestTab7 = Page1:CreateSection({
    Name = "Legendarysword", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})

local LabelByNino = TestTab7:AddLabel({
    Name = "Legendarysword"
})


local TestTab8 = Page1:CreateSection({
    Name = "Saber", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})

local LabelByNino = TestTab8:AddLabel({
    Name = "AutoSaber"
})
...
TestTab1:AddToggle({
	...
	Value = _G.Auto_Farm_Chest,
    Callback = function(t)
        _G.Auto_Farm_Chest = t
    end
})
...
local TestTab9 = Page1:CreateSection({
    Name = "Rengoku", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})

local LabelByNino = TestTab9:AddLabel({
    Name = "AutoRengoku"
})
...
local TestTab14 = Page1:CreateSection({
    Name = "Player", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
...
local TestTab10 = Page1:CreateSection({
    Name = "CakePrince", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})


local TestTab15 = Page2:CreateSection({
    Name = "Shop", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})

local LabelByNino = TestTab10:AddLabel({
    Name = "CakePrince"
})

TestTab10:AddToggle({
    Name = "AutoCakePrince",
	Value = _G.AutoDoughKingV1,
    Callback = function(t)
...
TestTab10:AddToggle({
    Name = "AutoChocolateBarBattler",
	Value = _G.AutoDoughKingV2,
    Callback = function(t)
...
local LabelByNino = TestTab15:AddLabel({
    Name = "Shop"
})
...
TestTab7:AddToggle({
    Name = "AutoLegendarysword",
	Value = _G.AutoLegendarysword,
    Callback = function(t)
        _G.AutoLegendarysword = t
    end
})

local LabelByNino = TestTab6:AddLabel({
    Name = "Fram Bone"
})
...
local LabelByNino = TestTab5:AddLabel({
    Name = "Elite Hunter"
})


local LabelByNino = TestTab14:AddLabel({
    Name = "Player"
})
...
local LabelByNino = TestTab4:AddLabel({
    Name = "RandomCode"
})
...
local LabelByNino = TestTab3:AddLabel({
    Name = "Fighting Style"
})

TestTab3:AddToggle({
    Name = "Superhuman/GodHuman",
	Value = _G.AutoSuperhuman,
	Value = _G.AutoGodhuman,
    Callback = function(t)
        _G.AutoSuperhuman = t
        _G.AutoGodhuman = t
    end
...
TestTab3:AddToggle({
    Name = "Dragon Claw",
	Value = _G.AutoDragonTalon,
    Callback = function(t)
        _G.AutoDragonTalon = t
    end
})
...
local LabelByNino = TestTab2:AddLabel({
    Name = "Stats/Poins"
})

Stats = {"Melee","Defense","Sword","Gun","Fruit"}

ItemList = Stats
TestTab2:AddDropdown({
	Name = "Select Stats",
	Value = "", -- ค่าที่จะให้มันเลือก
	List = ItemList,
	Callback = function(value)
...
local LabelByNino = TestTab1:AddLabel({
    Name = "AutoFram/AutoWorld"
})
TestTab1:AddToggle({
    Name = "AutoFram",
	Value = _G.AutoFarm,
                    ...
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress").TalkedSon == true and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress").UsedRelic == false then
                        for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                            if v.Name == "Mob Leader [Lv. 120] [Boss]" then
                                if v:FindFirstChild("HumanoidRootPart") then
                                    repeat task.wait()
                                        EquipTool(_G.SWeapon)
                                        Tween(v.HumanoidRootPart.CFrame * CFrame.new(5,15,5))
                        ...
                        for x,y in pairs(game.ReplicatedStorage:GetChildren()) do
                            if y.Name == "Mob Leader [Lv. 120] [Boss]" then
                                if y:FindFirstChild("HumanoidRootPart") then
                                    repeat task.wait()
                                        Tween(y.HumanoidRootPart.CFrame * CFrame.new(5,15,5))
                                    until not _G.AutoSaber
                                end
                            end
                        end
            ...
            if _G.AutoNextIsland then
                if game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible == true then
                    ...
                    if Island:FindFirstChild("Island 5") then
                        Tween(Island["Island 5"].CFrame * CFrame.new(0,35,5))
                    elseif Island:FindFirstChild("Island 4") then
                        Tween(Island["Island 4"].CFrame * CFrame.new(0,35,5))
                    elseif Island:FindFirstChild("Island 3") then
                        Tween(Island["Island 3"].CFrame * CFrame.new(0,35,5))
                    elseif Island:FindFirstChild("Island 2") then
                        Tween(Island["Island 2"].CFrame * CFrame.new(0,35,5))
                    elseif Island:FindFirstChild("Island 1") then
                        Tween(Island["Island 1"].CFrame * CFrame.new(0,35,5))
                    end
                end
            end
        end)
